...
export type CapabilityKey="google_business_profile"|"google_drive"|"google_ads"|"google_analytics"|"google_tag_manager"|"meta_ads"|"facebook_pages"|"instagram_business"|"ai_generation";
...
export const providers:ProviderDefinition[]=[
 {key:"google",name:"Google",group:"Google",description:"Perfil da Empresa, Drive, anúncios e mensuração em uma conexão simples.",availability:"ready",managementMode:"platform_managed",capabilities:[{key:"google_business_profile",name:"Perfil da Empresa",help:"A ficha da empresa que aparece no Google e no Google Maps."},{key:"google_drive",name:"Google Drive",help:"Criação controlada da pasta numerada de cada cliente a partir do modelo da Alastre."},{key:"google_ads",name:"Google Ads",help:"Contas de anúncios e campanhas autorizadas."},{key:"google_analytics",name:"Google Analytics",help:"Propriedades usadas para medir visitas e resultados."},{key:"google_tag_manager",name:"Google Tag Manager",help:"Contêineres que organizam a mensuração do site."}]},
