...
- **Process**: Which data, validations, rules and tools materially supported the output?
...
- **Decision summaries**: Showing evidence, assumptions, validations and concise rationale without exposing private chain-of-thought
...
For Alastre interfaces, use stable human states where relevant: **Dados reais**, **Dados parciais**, **Sugestão da IA**, **Não conectado**, **Não disponível**, **Demonstração** and **Erro de sincronização**. Never request, persist or display private chain-of-thought. Transparency means provenance and verifiable decision summaries, not hidden-token disclosure.
